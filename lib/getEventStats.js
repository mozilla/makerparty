...
module.exports = function(options, callback) {
  ...
  request.get(options.url + '/events?after=' + encodeURIComponent(options.start_date) + '&before=' + encodeURIComponent(options.end_date), function(events_fetch_error, response, body) {
    if (events_fetch_error) {
      return callback(events_fetch_error);
    }
